...
if __name__ == '__main__':
    ...
    save_dir = os.path.join(os.path.expanduser('~/'), "adr/plot_figure/multiple")
    data_path = os.path.join(os.path.expanduser('~/'), "adr/plot_data/multiple/aggr%d_iter%d_multiple.pickle"
                             % (args.aggressive, args.iter))
