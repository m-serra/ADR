...
def main():
    ...
    train_adr_vp(frames,
                 ...
                 config=config,
                 ec_filename='Ec_o_overfit.h5',
                 a_filename='A_o_overfit.h5',
                 eo_filename='Eo_overfit.h5',
                 do_filename='D_o_overfit.h5',
                 l_filename='L_overfit.h5',
                 la_filename='La_o_overfit.h5',
                 da_filename='Da_o_overfit.h5',
...
def train_adr_vp(frames, actions, states, hc_dim, ha_dim, ho_dim, za_dim=10, gaussian_a=False, context_frames=2,
                 ...
                 learning_rate=0.001, action_net_units=256, val_iterator=None, val_steps=None, output_regularizer=None,
                 lstm_units=256, lstm_layers=2, lstm_a_layers=1, lstm_a_units=256,neptune_log=False, neptune_ckpt=False,
    ...
    if neptune_log or neptune_ckpt:
        neptune.init('m-serra/adr_vp')
        neptune.create_experiment(name='adr_vp')
    ...
    L = simple_lstm(batch_shape=[bs, None, hc_dim + ha_dim*2 + ho_dim], output_dim=ho_dim, n_layers=lstm_layers,
                    units=lstm_units)
